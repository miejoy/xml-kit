...
final class XMLParserTests: XCTestCase {
    ...
    func testParse() throws {
        ...
        XCTAssertEqual(rootElement.name, "user")
        XCTAssertEqual(rootElement.attributes["id"], s_int.description)
        XCTAssertEqual(rootElement.attributes["alias"], s_strOption)
        XCTAssertEqual(rootElement.children.first?.name, "name")
    ...
    func testAttrJSONEncoderAndJSONDecoder() throws {
        ...
        let newData = try JSONEncoder().encode(tmpUser)
        let user = try decoder.decode(UserMix.self, from: newData)
